...
if ( ! function_exists( 'biagiotti_mikado_get_blog_holder_params' ) ) {
	...
	function biagiotti_mikado_get_blog_holder_params( $params ) {
		...
		$masonry_layout = biagiotti_mikado_get_meta_field_intersect( 'blog_masonry_layout' );
...
if ( ! function_exists( 'biagiotti_mikado_get_blog_list_classes' ) ) {
	/**
	 * Function that generates blog list holder classes for blog list templates
	 */
	function biagiotti_mikado_get_blog_list_classes( $classes ) {
		$list_classes   = array();
		$list_classes[] = 'mkdf-grid-list mkdf-grid-masonry-list';
		
		$number_of_columns = biagiotti_mikado_get_meta_field_intersect( 'blog_masonry_number_of_columns' );
		if ( ! empty( $number_of_columns ) ) {
			$list_classes[] = 'mkdf-' . $number_of_columns . '-columns';
		}
		
		$space_between_items = biagiotti_mikado_get_meta_field_intersect( 'blog_masonry_space_between_items' );
	...
	add_filter( 'biagiotti_mikado_filter_blog_list_classes', 'biagiotti_mikado_get_blog_list_classes' );
}
