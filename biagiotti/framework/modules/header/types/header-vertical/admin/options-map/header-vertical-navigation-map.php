...
if ( ! function_exists( 'biagiotti_mikado_get_hide_dep_for_header_vertical_menu_options' ) ) {
	function biagiotti_mikado_get_hide_dep_for_header_vertical_menu_options() {
		$hide_dep_options = apply_filters( 'biagiotti_mikado_filter_header_vertical_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'biagiotti_mikado_header_vertical_navigation_options_map' ) ) {
	function biagiotti_mikado_header_vertical_navigation_options_map() {
		$hide_dep_options = biagiotti_mikado_get_hide_dep_for_header_vertical_menu_options();
		
		$panel_vertical_main_menu = biagiotti_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Vertical Main Menu', 'biagiotti' ),
		...
		$drop_down_group = biagiotti_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Set a style for dropdown menu', 'biagiotti' )
			)
		);
		
		$vertical_drop_down_row1 = biagiotti_mikado_add_admin_row(
			array(
		...
		biagiotti_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Top Margin', 'biagiotti' ),
				'args'          => array(
					'suffix' => 'px'
				),
		...
		biagiotti_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Bottom Margin', 'biagiotti' ),
				'args'          => array(
					'suffix' => 'px'
				),
				'parent'        => $vertical_drop_down_row1
		...
		biagiotti_mikado_add_admin_field(
			array(
				...
				'default_value' => 'below',
				'label'         => esc_html__( 'Submenu Opening', 'biagiotti' ),
				'options'		=> array(
					'below' => esc_html__('Below', 'biagiotti'),
					'side' => esc_html__('On Side', 'biagiotti'),
				),
				'parent'        => $panel_vertical_main_menu
			)
		);

		$group_vertical_first_level = biagiotti_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_first_level',
				'title'       => esc_html__( '1st level', 'biagiotti' ),
				'description' => esc_html__( 'Define styles for 1st level menu', 'biagiotti' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_first_level_1 = biagiotti_mikado_add_admin_row(
			array(
		...
		$row_vertical_first_level_2 = biagiotti_mikado_add_admin_row(
			array(
		...
		$row_vertical_first_level_3 = biagiotti_mikado_add_admin_row(
			array(
		...
		$group_vertical_second_level = biagiotti_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_second_level',
				'title'       => esc_html__( '2nd level', 'biagiotti' ),
				'description' => esc_html__( 'Define styles for 2nd level menu', 'biagiotti' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_second_level_1 = biagiotti_mikado_add_admin_row(
			array(
		...
		$row_vertical_second_level_2 = biagiotti_mikado_add_admin_row(
			array(
		...
		$row_vertical_second_level_3 = biagiotti_mikado_add_admin_row(
			array(
		...
		$group_vertical_third_level = biagiotti_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_third_level',
				'title'       => esc_html__( '3rd level', 'biagiotti' ),
				'description' => esc_html__( 'Define styles for 3rd level menu', 'biagiotti' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_third_level_1 = biagiotti_mikado_add_admin_row(
			array(
		...
		$row_vertical_third_level_2 = biagiotti_mikado_add_admin_row(
			array(
		...
		$row_vertical_third_level_3 = biagiotti_mikado_add_admin_row(
			array(
	...
	add_action( 'biagiotti_mikado_action_additional_header_main_navigation_options_map', 'biagiotti_mikado_header_vertical_navigation_options_map', 10, 1 );
}