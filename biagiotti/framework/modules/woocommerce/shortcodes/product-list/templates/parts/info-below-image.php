...
<div class="mkdf-pli mkdf-item-space <?php echo esc_attr( $item_classes ); ?>">
	<div class="mkdf-pli-inner">
		...
		<div class="mkdf-pli-text" <?php echo biagiotti_mikado_get_inline_style( $shader_styles ); ?>>
	...
	<div class="mkdf-pli-text-wrapper" <?php echo biagiotti_mikado_get_inline_style( $text_wrapper_styles ); ?>>
