...
if ( class_exists( 'BiagiottiCoreClassWidget' ) ) {
	class BiagiottiMikadoClassContactForm7Widget extends BiagiottiCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'mkdf_contact_form_7_widget',
				esc_html__( 'Biagiotti Contact Form 7 Widget', 'biagiotti' ),
				array( 'description' => esc_html__( 'Add contact form 7 to widget areas', 'biagiotti' ) )
			);
		...
		protected function setParams() {
			...
			$this->params = array(
				array(
					'type'  => 'textfield',
					'name'  => 'extra_class',
					'title' => esc_html__( 'Extra Class Name', 'biagiotti' )
				),
				array(
					'type'  => 'textfield',
				...
				array(
					'type'    => 'dropdown',
					'name'    => 'contact_form',
					'title'   => esc_html__( 'Select Contact Form 7', 'biagiotti' ),
					'options' => $contact_forms
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'contact_form_style',
					'title'   => esc_html__( 'Contact Form 7 Style', 'biagiotti' ),
					'options' => array(
		...
		public function widget( $args, $instance ) {
			...
			?>
			<div class="widget mkdf-contact-form-7-widget <?php echo esc_attr( $extra_class ); ?>" <?php echo biagiotti_mikado_get_inline_style( $widget_styles ); ?>>
