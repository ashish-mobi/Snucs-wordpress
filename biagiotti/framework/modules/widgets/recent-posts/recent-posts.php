...
if ( class_exists( 'BiagiottiCoreClassWidget' ) ) {
	class BiagiottiMikadoClassRecentPosts extends BiagiottiCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'mkdf_recent_posts',
				esc_html__( 'Biagiotti Recent Posts', 'biagiotti' ),
				array( 'description' => esc_html__( 'Select recent posts that you would like to display', 'biagiotti' ) )
			);
		...
		public function widget( $args, $instance ) {
			...
			$html = '<div class="widget mkdf-recent-post-widget" ' . biagiotti_mikado_get_inline_style( $widget_styles ) . '>';
			...
			if ( $query->have_posts() ) {
				...
				$html .= esc_html__( 'Sorry, there are no posts matching your criteria', 'biagiotti' );
			}
