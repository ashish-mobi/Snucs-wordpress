...
if ( class_exists( 'BiagiottiCoreClassWidget' ) ) {
	class BiagiottiMikadoClassBlogListWidget extends BiagiottiCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'mkdf_blog_list_widget',
				esc_html__( 'Biagiotti Blog List Widget', 'biagiotti' ),
				array( 'description' => esc_html__( 'Display a list of your blog posts', 'biagiotti' ) )
			);
		...
		protected function setParams() {
			$this->params = array(
				...
				array(
					...
					'title' => esc_html__( 'Number of Posts', 'biagiotti' )
				),
				array(
					'type'    => 'dropdown',
				...
				array(
					'type'    => 'dropdown',
					'name'    => 'orderby',
					'title'   => esc_html__( 'Order By', 'biagiotti' ),
					'options' => biagiotti_mikado_get_query_order_by_array()
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'order',
					'title'   => esc_html__( 'Order', 'biagiotti' ),
					'options' => biagiotti_mikado_get_query_order_array()
				),
				array(
					'type'        => 'textfield',
					'name'        => 'category',
					'title'       => esc_html__( 'Category Slug', 'biagiotti' ),
					'description' => esc_html__( 'Leave empty for all or use comma for list', 'biagiotti' )
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'title_tag',
				...
				array(
					...
					'title'   => esc_html__( 'Title Text Transform', 'biagiotti' ),
					'options' => biagiotti_mikado_get_text_transform_array( true )
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'title_font_weight',
					'title'   => esc_html__( 'Title Font Weight', 'biagiotti' ),
		...
		public function widget( $args, $instance ) {
			...
			echo '<div class="widget mkdf-blog-list-widget" ' . biagiotti_mikado_get_inline_style( $widget_styles ) . '>';
