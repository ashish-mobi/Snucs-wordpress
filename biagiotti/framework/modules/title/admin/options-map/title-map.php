...
if ( ! function_exists( 'biagiotti_mikado_get_title_types_options' ) ) {
	function biagiotti_mikado_get_title_types_options() {
		$title_type_options = apply_filters( 'biagiotti_mikado_filter_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'biagiotti_mikado_get_title_type_default_options' ) ) {
	function biagiotti_mikado_get_title_type_default_options() {
		$title_type_option = apply_filters( 'biagiotti_mikado_filter_default_title_type_global_option', $title_type_option = '' );
		
		return $title_type_option;
	}
}

foreach ( glob( BIAGIOTTI_MIKADO_FRAMEWORK_MODULES_ROOT_DIR . '/title/types/*/admin/options-map/*.php' ) as $options_load ) {
	include_once $options_load;
}

if ( ! function_exists('biagiotti_mikado_title_options_map') ) {
	function biagiotti_mikado_title_options_map() {
		$title_type_options        = biagiotti_mikado_get_title_types_options();
		$title_type_default_option = biagiotti_mikado_get_title_type_default_options();
		...
		$panel_title = biagiotti_mikado_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'biagiotti')
			)
		);
		...
		biagiotti_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'biagiotti' ),
				'parent'        => $panel_title
			)
		);
		
			$show_title_area_container = biagiotti_mikado_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				biagiotti_mikado_add_admin_field(
					...
					biagiotti_mikado_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'biagiotti' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'biagiotti_mikado_action_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = biagiotti_mikado_add_admin_panel(
			array(
				'page'  => '_title_page',
			...
			$group_page_title_styles = biagiotti_mikado_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'biagiotti' ),
					'description' => esc_html__( 'Define styles for page title', 'biagiotti' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = biagiotti_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_2 = biagiotti_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = biagiotti_mikado_add_admin_row(
					array(
			...
			biagiotti_mikado_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'biagiotti' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = biagiotti_mikado_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'biagiotti' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'biagiotti' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = biagiotti_mikado_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_2 = biagiotti_mikado_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = biagiotti_mikado_add_admin_row(
					array(
		...
		do_action( 'biagiotti_mikado_action_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'biagiotti_mikado_action_options_map', 'biagiotti_mikado_title_options_map', biagiotti_mikado_set_options_map_position( 'title' ) );
}