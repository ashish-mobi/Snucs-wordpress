...
if ( ! function_exists( 'biagiotti_mikado_add_dripicons_icon_pack' ) ) {
	function biagiotti_mikado_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new BiagiottiMikadoClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_collection', 'biagiotti_mikado_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'biagiotti_mikado_add_dripicons_icon_pack_option' ) ) {
	function biagiotti_mikado_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'biagiotti' );
		
		return $options;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_options', 'biagiotti_mikado_add_dripicons_icon_pack_option' );
}

class BiagiottiMikadoClassDripicons implements iBiagiottiMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->param = $param;
        $this->setIconsArray();
        $this->styleUrl = BIAGIOTTI_MIKADO_FRAMEWORK_ICONS_ROOT . '/dripicons/dripicons.css';
    }
