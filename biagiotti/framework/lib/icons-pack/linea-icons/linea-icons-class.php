...
if ( ! function_exists( 'biagiotti_mikado_add_linea_icon_pack' ) ) {
	function biagiotti_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new BiagiottiMikadoClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_collection', 'biagiotti_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'biagiotti_mikado_add_linea_icon_pack_option' ) ) {
	function biagiotti_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'biagiotti' );
		
		return $options;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_options', 'biagiotti_mikado_add_linea_icon_pack_option' );
}

class BiagiottiMikadoClassLineaIcons implements iBiagiottiMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = BIAGIOTTI_MIKADO_FRAMEWORK_ICONS_ROOT . '/linea-icons/style.css';
	}
