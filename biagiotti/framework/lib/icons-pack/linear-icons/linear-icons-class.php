...
if ( ! function_exists( 'biagiotti_mikado_add_linear_icon_pack' ) ) {
	function biagiotti_mikado_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new BiagiottiMikadoClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_collection', 'biagiotti_mikado_add_linear_icon_pack' );
}

if ( ! function_exists( 'biagiotti_mikado_add_linear_icon_pack_option' ) ) {
	function biagiotti_mikado_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'biagiotti' );
		
		return $options;
	}
	
	add_filter( 'biagiotti_mikado_filter_add_icon_pack_into_options', 'biagiotti_mikado_add_linear_icon_pack_option' );
}

class BiagiottiMikadoClassLinearIcons implements iBiagiottiMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = BIAGIOTTI_MIKADO_FRAMEWORK_ICONS_ROOT . '/linear-icons/style.css';
	}
