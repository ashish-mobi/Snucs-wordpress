...
/*
   Class: BiagiottiMikadoClassDashboardForm
   A class that initializes Mikado Dashboard Container
*/

class BiagiottiMikadoClassDashboardForm implements iBiagiottiMikadoInterfaceLayoutNode, iBiagiottiMikadoInterfaceRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
...
/*
   Class: BiagiottiMikadoClassDashboardGroup
   A class that initializes BiagiottiMikadoClass Group Field
*/
class BiagiottiMikadoClassDashboardGroup implements iBiagiottiMikadoInterfaceLayoutNode, iBiagiottiMikadoInterfaceRender {
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: BiagiottiMikadoClassDashboardTitle
   A class that initializes Dashboard Title
*/
class BiagiottiMikadoClassDashboardTitle implements iBiagiottiMikadoInterfaceRender {
	private $name;
	private $title;
	private $args = array();
...
/*
   Class: BiagiottiMikadoClassDashboardField
   A class that initializes BiagiottiMikadoClass Front Field
*/
class BiagiottiMikadoClassDashboardField implements iBiagiottiMikadoInterfaceRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class BiagiottiMikadoClassDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class BiagiottiMikadoClassDashboardFieldText extends BiagiottiMikadoClassDashboardFieldType {
...
class BiagiottiMikadoClassDashboardFieldTextArea extends BiagiottiMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class BiagiottiMikadoClassDashboardFieldImage extends BiagiottiMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
			...
			<div class="mkdf-dashboard-gallery-holder">
				<ul class="mkdf-dashboard-gallery-images-holder">
					<?php if ( isset( $value_html ) ) {
						echo biagiotti_mikado_get_module_part( $value_html );
					} ?>
				</ul>
				<div class="mkdf-dashboard-gallery-uploader">
					...
					if ( biagiotti_membership_theme_installed() ) {
						echo biagiotti_mikado_get_button_html( array(
							'text'         => esc_html__( 'Upload', 'biagiotti' ),
							'custom_class' => 'mkdf-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" class="mkdf-btn mkdf-btn-medium mkdf-btn-solid mkdf-dashboard-gallery-upload"><span class="mkdf-btn-text">' . esc_html__( 'Upload', 'biagiotti' ) . '</span></a>';
					} ?>
					...
					<?php if ( $value !== '' && $value !== false ) { ?>
						<button class="mkdf-btn mkdf-btn-solid mkdf-dashboard-remove-image"><?php esc_html_e( 'Remove Media', 'biagiotti' ); ?></button>
					<?php } ?>
				</div>
			</div>
		</div>
...
class BiagiottiMikadoClassDashboardFieldGallery extends BiagiottiMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class BiagiottiMikadoClassDashboardFieldSelect extends BiagiottiMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class BiagiottiMikadoClassDashboardFieldDate extends BiagiottiMikadoClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class BiagiottiMikadoClassDashboardFieldIcon extends BiagiottiMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$options           = biagiotti_mikado_icon_collections()->getIconCollectionsEmpty();
...
class BiagiottiMikadoClassDashboardFieldColor extends BiagiottiMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class BiagiottiMikadoClassDashboardFieldCheckBoxGroup extends BiagiottiMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class BiagiottiMikadoClassDashboardFieldAddress extends BiagiottiMikadoClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
...
class BiagiottiMikadoClassDashboardRepeater implements iBiagiottiMikadoInterfaceRender {
	private $label;
	private $description;
	private $name;
	private $fields;
			...
			<?php if ( $this->table_layout ) { ?>
				<div class="mkdf-dashboard-repeater-table-heading">
					<div class="mkdf-dashboard-repeater-fields-holder">
						<div class="mkdf-dashboard-repeater-table-cell mkdf-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'biagiotti' ) ?></div>
						...
						<div class="mkdf-dashboard-repeater-table-cell mkdf-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'biagiotti' ) ?></div>
					</div>
				</div>
			<?php } ?>
...
class BiagiottiMikadoClassDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new BiagiottiMikadoClassDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'textarea':
				$field = new BiagiottiMikadoClassDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'date':
				$field = new BiagiottiMikadoClassDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'image':
				$field = new BiagiottiMikadoClassDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'gallery':
				$field = new BiagiottiMikadoClassDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'select':
				$field = new BiagiottiMikadoClassDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'icon':
				$field = new BiagiottiMikadoClassDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'color':
				$field = new BiagiottiMikadoClassDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'checkboxgroup':
				$field = new BiagiottiMikadoClassDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'address':
				$field = new BiagiottiMikadoClassDashboardFieldAddress();
